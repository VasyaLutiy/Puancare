...
Ничего не пиши после ===END===. Донор и цель делят по ИМЕНИ действие-зонд и
действие-вопрос. КОНТРАКТ: исходы действия-ВОПРОСА — ОБЩИЕ (то же множество
слов) у донора и цели; остальные слова (скрытое, видимое, исходы зонда,
имена) — у цели свои.
"""
